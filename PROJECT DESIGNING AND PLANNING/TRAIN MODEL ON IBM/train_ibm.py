...
train_gen = train_datagen.flow_from_directory(r'/content/drive/MyDrive/train-20221106T023729Z-001/train',
        target_size=(128,128),
...
test_gen = test_datagen.flow_from_directory(r'/content/drive/MyDrive/test-20221106T023808Z-001/test',
        target_size=(128,128),
        color_mode='grayscale',
        batch_size=32,
        classes=['0','1','2','3','4','5'],
